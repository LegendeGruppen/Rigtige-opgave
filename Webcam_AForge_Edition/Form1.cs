...
namespace Webcam_AForge_Edition
{
    public partial class Form1 : Form
    {
        ...
        internal GlobalVars gv; //Instantiate Globale var

        public Form1()
        {
            InitializeComponent();
            buttonCamStart.Enabled = false;
            gv = new GlobalVars(); //Initiallize variable 
        }
        ...
        private void buttonCapture_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("You need to choose a camera first", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
